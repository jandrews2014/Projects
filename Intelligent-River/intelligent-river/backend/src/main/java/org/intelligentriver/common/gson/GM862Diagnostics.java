...
/*
 * a gson data class used to represent a gm862 diagnostic record
 */
public class GM862Diagnostics {
	...
	private Long gsmRegistrationErrors;
	private Long gprsRegistrationErrors;
	...
	public long getGsmRegistrationErrors() {
		return gsmRegistrationErrors;
	}

	public void setGsmRegistrationErrors(long gsmRegistrationErrors) {
		this.gsmRegistrationErrors = gsmRegistrationErrors;
	}

	public long getGprsRegistrationErrors() {
		return gprsRegistrationErrors;
	}

	public void setGprsRegistrationErrors(long gprsRegistrationErrors) {
		this.gprsRegistrationErrors = gprsRegistrationErrors;
	}
