...
Rollup_CSZ := ROLLUP(S_Recs, LEFT.Zipcode=RIGHT.Zipcode AND LEFT.State=RIGHT.State AND LEFT.City=RIGHT.City, RollCSV(LEFT,RIGHT)); 

OUTPUT(Rollup_CSZ,,'~ONLINE::JMA::OUT::LookupCSZ',overwrite)